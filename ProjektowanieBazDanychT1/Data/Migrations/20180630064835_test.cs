        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UserWhoAnsweredId = table.Column<string>(nullable: true),
                    WhenParticipated = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tests_AspNetUsers_UserWhoAnsweredId",
                        column: x => x.UserWhoAnsweredId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCorect = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_UserWhoAnsweredId",
                table: "Tests",
                column: "UserWhoAnsweredId",
                unique: true,
                filter: "[UserWhoAnsweredId] IS NOT NULL");
        }
